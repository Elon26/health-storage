export type GalleryFetchStatus = 'unknown' | 'error' | 'fetching' | 'fetched' | 'blocked';
...
export type GalleryCleanerAlbum = (typeof GalleryCleanerAvailableAlbums)[number];

export function isGalleryCleanerAlbum(value: unknown): value is GalleryCleanerAlbum {
  return (
    typeof value === 'string' &&
